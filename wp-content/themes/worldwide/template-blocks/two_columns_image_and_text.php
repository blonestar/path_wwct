		...
		<div class="container">
			<div>
				<div class="col-sm-6<?php echo (get_sub_field('image_position') == 'left') ? ' col-sm-push-6' : '' ?>"><div class="about-content-box">
						<h2>
							<?php if (get_sub_field('link') != "") { ?><a href="<?php the_sub_field('link') ?>"><?php } ?><?php echo get_sub_field('title') ?><?php if (get_sub_field('link') != "") { ?></a><?php } ?></h2>

						<?php the_sub_field("content") ?>

						<?php if (get_sub_field('button_label') != "") { ?>
						<p><?php if (get_sub_field('link') != "") { ?><a class="btn btn-md btn-default" href="<?php the_sub_field('link') ?>"><?php } ?>Learn More<?php if (get_sub_field('link') != "") { ?></a><?php } ?></p>
						<?php } ?>
