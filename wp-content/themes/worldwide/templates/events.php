...
<div class="container-wrapper standard-container-wrapper ">
	<div class="container">
		<div class="news-list">
			...
			?>
			<div class="news-item">
				<div class="news-title">					<?php if (get_field('document_type') != 'lead') { ?>
					<a href="<?php the_permalink() ?>"><?php the_title() ?></a>					<?php } else { ?>					<?php the_title() ?>					<?php } ?>
				</div>
				<div class="news-summary-date">
					<?php /* <span class="news-date"><strong><?php the_date() ?></strong></span> */ ?>
					<span class="news-summary"><?php the_excerpt() ?></span>
				</div>				<?php if (get_field('document_type') != 'lead') { ?>
				<div class='read-more '>
