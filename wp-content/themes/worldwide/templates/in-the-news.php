			...
			<div class="news-item">
				...
				<div class='read-more '>
					...
					<div class="view-video featured-resource">
						<a href="<?php the_permalink() ?>" data-toggle="modal" data-target=".video-modal" data-title="<?php the_title() ?>"><?php echo get_post_read_label(get_the_ID()); ?> &rsaquo;</a>
					</div>

					<?php } else { ?>
						<a href="<?php the_permalink() ?>"><?php echo get_post_read_label(get_the_ID()); ?> &rsaquo;</a>
					<?php } ?>
				</div>
			</div>
			<?php
