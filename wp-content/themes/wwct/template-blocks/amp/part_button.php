...
<?php if (get_sub_field('button_type') == 'normal' || ! get_sub_field('button_type')) { ?>
    <a href="<?php the_sub_field('button_link') ?>" class="btn <?php echo (get_sub_field('button_outline')) ? ' btn-outline' : '' ?>"<?php echo (get_sub_field('button_rel')) ? ' rel="'.get_sub_field('button_rel').'"' : '' ?><?php echo (get_sub_field('button_target')) ? ' target="'.get_sub_field('button_target').'"' : ''; ?><?php //echo $style_inline ?>><?php the_sub_field('button_icon') ?> <?php the_sub_field('button_title') ?></a>
<?php } else { ?>
