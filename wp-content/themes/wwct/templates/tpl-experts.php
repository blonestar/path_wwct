...
<?php
	...
	$count = count($terms_arr);	for ($i=0; $i<$count; $i++) {
		$terms_arr[$i]->sort_order = get_field('tax_order', 'experts_tax_'.$terms_arr[$i]->term_id);
	}
	...
	<section class="team-members">
		<div class="container">
			<div class="row">
				...
				<div class="col-xs-6 col-sm-4 col-md-4 leadership-member-summary text-center">
					...
					<div class="expert-buttons row">
						<div class="col-10 offset-1">
							<a href="<?php the_permalink() ?>" class="btn">Ask me a Question</a>
						</div>
						<?php /*
						<div class="col-6">
