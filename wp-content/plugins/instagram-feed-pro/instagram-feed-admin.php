...
function sbi_welcome_screen_new_content() { ?>
    <div class="wrap about-wrap sbi-welcome">
        ...
        <p class="about-description"><?php _e("Let's take a look at what's new in version 2.10."); ?></p>

        <div class="changelog">
            <h3><?php _e('An Easier way to Connect and Manage Instagram Accounts'); ?></h3>
            <div class="feature-section">
                <div class="sbi-feature-section-media">
                    <img src="<?php echo plugins_url( 'img/welcome-connected-accounts.png' , __FILE__ ) ?>" style="padding: 0px; background: white;">
                </div>

                <div class="sbi-feature-section-content">
                    <p><?php _e("Easily connect and manage multiple Instagram accounts using our improved interface for managing account information."); ?></p>

                    <h4><?php _e("Connecting Accounts"); ?></h4>
                    <p><?php _e("While on the Configure tab, click on the big blue button to connect an account, or use the \"Manually Connect an Account\" option to connect one using an existing Access Token."); ?></p>
                    <h4><?php _e("Displaying User Accounts"); ?></h4>
                    <p><?php _e("Once an account is connected, you can use the associated buttons to either add it to your primary User feed or to a different feed on your site. "); ?></p>
            ...
            <div class="changelog">
                <div class="feature-section">
                    ...
                    <div class="sbi-feature-section-content">
                        ...
                        <p><?php _e("We've made configuring your feed super simple. Just use the big blue button on the plugin's "); ?><a href="admin.php?page=sb-instagram-feed&amp;tab=configure" target="_blank"><?php _e("Settings page"); ?></a> <?php _e(" to connect your Instagram account."); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="changelog">
                <div class="feature-section">
                    ...
                    <div class="sbi-feature-section-content">
                        ...
                        <p><?php _e("Choose to display posts from a user account, hashtag, location, or coordinates. You can also choose to display single posts from an account you've connected to."); ?></p>
                    </div>
                </div>
            </div>
...
function sbi_welcome_header(){ ?>
    ...
    <div id="sbi-header">
        ...
        <p class="about-text">
			<?php _e("Thanks for installing <b>Version 2.10</b> of the Instagram Feed Pro plugin! Use the tabs below to see what's new or to get started using the plugin."); ?>
        </p>
    </div>
<?php }
                    ...
                    <td>
                        ...
                        <div class="sbi_row">
                            ...
                            <div class="sbi_col sbi_two">
                                ...
                                <p class="sbi_tooltip"><?php _e("Display photos from a specific hashtag instead of from a user. Separate multiple hashtags using commas. &nbsp;<b>Note:</b> To display a hashtag feed, you'll still need to connect an Instagram account above in order to access the Instagram API."); ?></p>
                            </div>
                        </div>
						<?php /*
                            <div class="sbi_row">
...
*/ ?>
                        ...
                        <div class="sbi_row">
                            <span class="sbi_note" style="margin: 10px 0 0 0; display: block;"><?php _e('Separate multiple hashtags or locations by using commas'); ?></span>
                        </div>
	...
	<?php } // End Configure tab ?>
		...
		<?php if( $sbi_active_tab == 'customize' ) { //Start Configure tab ?>
            ...
            <p style="margin: -10px 0 0 0; font-style: italic; font-size: 12px;"><?php _e('Comments available for user feeds only'); ?></p>
		...
		<?php if( $sbi_active_tab == 'display' ) { //Start Configure tab ?>
            ...
            <table class="sbi_shortcode_table">
                ...
                <tr>
                    <td>type</td>
                    <td><?php _e("Display photos from a connected User Account (user)<br />Display posts from a Hashtag (hashtag)<br />Display posts from a Location (location)<br />Display posts from Coordinates (coordinates)<br />Display post(s) by Post ID (single)"); ?></td>
